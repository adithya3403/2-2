...
// are capturing the results into a text file named "logfile". The structure of the text file is:
...
// from 128.120.56.214 would be retained since there is not another PHP vote from this IP address.
